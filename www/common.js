...
var GlobalService = /** @class */ (function () {
    function GlobalService(toastController, http, cookieService) {
    ...
    GlobalService.prototype.getUserInfos = function () {
        ...
        return new Promise(function (resolve) {
            if (_this.cookieService.check('token') === true) {
                ...
                _this.http.get('http://joingaia.fr/joingaia-back/?login=getUserInfos&token=' + _this.cookieService.get('token'))
    ...
    GlobalService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_4__["CookieService"]])
    ], GlobalService);
